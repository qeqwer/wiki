...
insert into `ebook`(id, name, description) values (1,'Spring Boot 入门救程', '零基础入门 Java 开发,企业级应用开发最佳首选框架');
...
insert into `ebook`(id, name, description) values (5,'Oracle 入门教', '零基础入门 Oracle 开发，企业级应用开发最佳首选框架');
